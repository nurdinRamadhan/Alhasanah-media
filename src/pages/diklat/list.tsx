        ...
        <div className="pb-20">
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button key="print" type="primary" icon={<PrinterOutlined />} onClick={handlePrintAction} className="bg-emerald-600 hover:bg-emerald-700 rounded-full px-6 shadow-md">Cetak Formulir F4</Button>
                ]}
                width={850}
                centered
            >
                {/* Kertas HVS Folio / F4 Setup via CSS inline */}
                <div className="bg-gray-200 p-4 rounded-lg overflow-y-auto max-h-[70vh] flex justify-center">
                    <div ref={componentRef} style={{ width: '21cm', minHeight: '33cm', background: 'white', padding: '1.5cm', fontFamily: '"Times New Roman", Times, serif', color: 'black', position: 'relative', boxShadow: '0 0 10px rgba(0,0,0,0.1)' }}>
                        <style>{`
                            @media print { 
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                            <div style={{ fontSize: '16px', fontWeight: 'bold' }}>YAYASAN PENDIDIKAN PONDOK PESANTREN</div>
