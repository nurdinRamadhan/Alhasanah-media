...
export const HafalanPeta        = React.lazy(() => import("./pages/hafalan/peta").then(m => ({ default: m.PetaHafalan })));
...
export const ForumModerationList = React.lazy(() => import("./pages/alumni/forum-moderation").then(m => ({ default: m.ForumModerationList })));
export const ForumReportsList   = React.lazy(() => import("./pages/alumni/forum-reports").then(m => ({ default: m.ForumReportsList })));
export const AlumniChatMonitoringList = React.lazy(() => import("./pages/alumni/chat-monitoring").then(m => ({ default: m.AlumniChatMonitoringList })));
