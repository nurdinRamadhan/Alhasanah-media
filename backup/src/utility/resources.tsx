...
export const resources: ResourceProps[] = [
  ...
  { name:"alumni_data",  list:"/alumni",      meta:{ label:"Alumni",            icon:<GlobalOutlined /> } },
  { name:"forum_threads", list:"/forum-alumni", meta:{ label:"Forum Alumni", icon:<MessageOutlined /> } },
  { name:"forum_reports", list:"/forum-reports", meta:{ label:"Laporan Forum", icon:<SafetyCertificateOutlined /> } },
